                ...
                return (
                    <div className="flex flex-col">
                        <div className="relative">
                            <input type="text" id="floating_filled" className={classNames("block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white  dark:focus:border-primary-900 focus:outline-none focus:ring-0 focus:border-primary-1100 peer", error && "border-2 dark:border-2 border-danger dark:border-danger dark:focus:border-danger focus:border-danger ")} placeholder=" " {...rest} />
                            <label htmlFor="floating_filled" className={classNames("absolute text-sm text-gray-500 dark:text-gray-400 duration-300 translate-x-8 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] right-2.5 peer-focus:text-primary-800 peer-placeholder-shown:translate-x-0 peer-focus:dark:text-primary-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:translate-x-8", error && "text-danger dark:text-danger peer-focus:dark:text-danger peer-focus:text-danger")}>{lable}</label>
                        </div>
